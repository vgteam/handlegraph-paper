...
ggplot(subset(bdsg.prof,graph.model=="vg"), aes(x=graph.avg.degree, y=graph.seq.length, color=graph.avg.path.depth)) + geom_point(alpha=I(1/3)) + scale_y_log10() + theme_bw() + theme_bw() + scale_color_gradientn(colors=c("blue", "red", "yellow"))
...
ggplot(bdsg.prof, aes(x=graph.seq.length, y=graph.node.count/handle.enumeration.time, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
...
ggplot(bdsg.prof, aes(x=graph.seq.length, y=graph.edge.count/edge.traversal.time, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
...
ggplot(bdsg.prof, aes(x=graph.seq.length, y=graph.step.count/path.traversal.time, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
...
#ggplot(bdsg.prof, aes(x=graph.seq.length, y=load.mem/graph.seq.length, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
#ggsave("bdsg.prof_load.mem_per_bp_vs_seq.length_logXY.pdf", width=9.3, height=4.71)
#ggplot(bdsg.prof, aes(x=graph.seq.length, y=build.mem/graph.seq.length, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
...
#ggplot(bdsg.prof, aes(x=graph.seq.length, y=graph.seq.length/load.time, color=graph.model)) + geom_point() + scale_x_log10() + scale_y_log10() + theme_bw()
