...
Early versions of the variation graph toolkit (\textsc{VG}) \citep{Garrison_2018} have provided a cautionary tale of a na\"ive implementation.
...
We have extended the graph representation in \textsc{VG}, previously described in \citep{Garrison_2018}, to match the \textsc{HandleGraph} API.
...
The hash table it uses is a drop-in replacement for the equivalent standard library (STL) data structure, and has been shown to outperform it in empirical evaluations \citep{brehm2019hash}.
