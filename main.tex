...
Flavia Villani\,$^{\text{\sfb 4}}$,
Cecilia Cisar\,$^{\text{\sfb 1, \sfb 2}}$,
Simon Heumos\,$^{\text{\sfb 5}}$,
Glenn Hickey\,$^{\text{\sfb 1, \sfb 2}}$,
...
$^{\text{\sf 4}}$Institute of Genetics and Biophysics, Consiglio Nazionale di Ricerche, Naples, Italy, 80131, and \\
$^{\text{\sf 5}}$Quantitative Biology Center (QBiC), University of T\"ubingen, T\"ubingen, Germany, 72076
}
...
\textbf{Contact:} \href{ergarris@ucsc.edu}{ergarris@ucsc.edu} \\
...
The novel challenges of analyzing data sets of this scale have led to the development of \vocab{computational pangenomics}, which focuses on analyzing populations of genomes rather than individuals \citep{computational2016computational}.
...
They also compactly represent many-way relationships between related genomes, such as whole genome alignments \citep{kehr2014genome}.
...
TODO
S.H. acknowledges funding from thecentral innovation programme (ZIM) for SMEs of the Federal Ministry for Economic Affairsand Energy of Germany.
