...
All of the implementations except XG are dynamic. \todo{are we going to roll XG into libbdsg? that's what this text sounds like}
...
\begin{figure}
  ...
  \caption{
    \label{fig:prof}
    \textbf{Performance of models on the graph collection. \todo{I think this figure needs more explanation in the caption}}
    }
\end{figure}
